    ...
    <tr>
      ...
      <td>
        <div className="flex gap-2 justify-end">
          <button onClick={() => handleClassDelete(_id)} className="flex gap-2 items-center bg-[#CDC7F8] px-2 py-1 font-semibold rounded-md transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-[#A69BFB] duration-300">
